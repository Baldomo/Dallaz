...
public class CustomButton extends JButton {
    ...
    private String fontPath = "Resources/digital.ttf";
    ...
    */
    private void _initFont() {
        try {
            font = Font.createFont(Font.TRUETYPE_FONT, getClass().getClassLoader().getResourceAsStream(fontPath)).deriveFont(Font.PLAIN, fontSize);
            setFont(font);
    ...
    public void changeFont(String path) {
        try {
            fontPath = path;
            font = Font.createFont(Font.TRUETYPE_FONT, getClass().getClassLoader().getResourceAsStream(fontPath)).deriveFont(Font.PLAIN, fontSize);
            setFont(font);
